                  ...
                  <View style={{ flex: 1, backgroundColor: '#000', borderTopRightRadius: 30, borderTopLeftRadius: 30, padding: 10, }}>
                    ...
                    <View style={{ marginBottom: 20 }} >
                      <View style={styles.totalCart}>
                        <Text style={{ color: '#919090', fontSize: 25 }}>Tổng:</Text>
                        <NumberFormat
                          value={price}
                          displayType={'text'}
                      ...
                      {amount == 0 ? undefined : (
                        <View style={{ marginTop: 10 }}>
                          <Text style={{ color: 'white', marginLeft: 15, marginBottom: 5 }}>Bạn muốn lấy khi nào?</Text>
                          ...
                          <View style={{ alignSelf: 'center', flexDirection: "row" }}>
                            <TouchableOpacity activeOpacity={0.7} onPress={() => { setCartItem([]); setAmount(0); setPrice(0) }}
                            >
